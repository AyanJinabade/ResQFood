...
const LandingPage = () => {
  ...
  const stats = [
    { value: "0", label: "People Fed", icon: Heart },
    { value: "0", label: "Active Partners", icon: Users },
    { value: "0", label: "Meals Rescued", icon: Utensils },
    { value: "0", label: "Cities Served", icon: MapPin },
  ];
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Connect restaurants, societies, and NGOs to eliminate food
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-green-300 hover:text-green-600 transition-colors flex items-center justify-center group">
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-2 hover:rotate-0 transition-transform duration-500 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-green-50 rounded-lg p-4 text-center">
                      ...
                      <div className="font-semibold">0 Meals</div>
                      <div className="text-sm text-gray-600">Available</div>
                    </div>
                    <div className="bg-blue-50 rounded-lg p-4 text-center">
                      <div className="text-2xl mb-2">🏢</div>
                      <div className="font-semibold">0 NGOs</div>
